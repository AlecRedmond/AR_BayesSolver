...
class BayesianNetworkTest {
  ...
  void testSolves() {
    ...
    generateSamples(numOfSamples, includedNode, testState, true);
  }

  private void generateSamples(
      int numOfSamples, String includedNode, String testState, boolean printAllToConsole) {
    ...
    List<List<String>> samples =
        test.generateSamples(numOfSamples, List.of(), List.of(includedNode), String.class);
  ...
  void testNetworkAH() {
    ...
    assertDoesNotThrow(
        () ->
            test.addConstraint("D+", List.of("A+"), 0.33)
    ...
    assertThrows(
        ...
        () -> test.addConstraint("D+", List.of("A+", "D-"), 0.5));
  }
