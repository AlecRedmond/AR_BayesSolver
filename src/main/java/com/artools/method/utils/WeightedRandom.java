 ...
 *
 * <p>This class provides two primary ways to select items:
 *
 * <ol>
 *   <li><b>Instance Method:</b> For scenarios where many selections will be made from the same set
 *       of weights. The constructor pre-calculates cumulative weights for efficiency.
 *   <li><b>Static Method:</b> For one-off selections where an instance is not needed. This is
 *       convenient but less performant if called repeatedly with the same weights.
 * </ol>
 *
