...
public class BayesianNetworkImpl implements BayesianNetwork {
  ...
  public <T extends Serializable, E extends Serializable> BayesianNetworkImpl addNewNode(T nodeID, Collection <E> nodeStateIDs) {
    networkData.setSolved(false);
  ...
  public <T extends Serializable, E extends Serializable> BayesianNetworkImpl addNodeStates(T nodeID, Collection <E> nodeStateIDs) {
    networkData.setSolved(false);
    NetworkDataUtils.addNodeStates(nodeID, nodeStateIDs, networkData);
    return this;
  }

  public  <T extends Serializable,E extends Serializable> BayesianNetworkImpl addNodeState(T nodeID, E nodeStateID) {
    networkData.setSolved(false);
  ...
  public  <T extends Serializable,E extends Serializable> BayesianNetworkImpl removeNodeState(T nodeID, E nodeStateID) {
    networkData.setSolved(false);
  ...
  public  <T extends Serializable,E extends Serializable> BayesianNetworkImpl addParents(T childID, Collection <E> parentIDs) {
    networkData.setSolved(false);
  ...
  public  <T extends Serializable,E extends Serializable> BayesianNetworkImpl addParent(T childID, E parentID) {
    networkData.setSolved(false);
  ...
  public  <T extends Serializable,E extends Serializable> BayesianNetworkImpl removeParent(T childID, E parentID) {
    networkData.setSolved(false);
  ...
  public  <T extends Serializable> BayesianNetworkImpl addConstraint(T eventStateID, double probability) {
    networkData.setSolved(false);
  ...
  public  <T extends Serializable,E extends Serializable> boolean removeConstraint(T eventStateId, Collection <E> conditionStateIds) {
    networkData.setSolved(false);
  ...
  public  <T extends Serializable> BayesianNetworkImpl observeNetwork(Collection <T> observedNodeStateIDs) {
    if (!networkData.isSolved()) solveNetwork();
  ...
  public  <T extends Serializable> SampleCollection generateSamples(int numberOfSamples, Collection <T> observedStateIDs) {
    if (!networkData.isSolved()) {
      solveNetwork();
    }
  ...
  public  <T extends Serializable> double getProbabilityFromCurrentObservations(Collection <T> eventStateIDs) {
    if (!networkData.isSolved()) solveNetwork();
