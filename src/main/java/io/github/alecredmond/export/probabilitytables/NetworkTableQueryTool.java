 ...
 * provides all the methods contained within {@link ProbabilityTableQueryTool}, plus additional methods to
 ...
 * @author Alec Redmond
 */
public interface NetworkTableQueryTool extends ProbabilityTableQueryTool {
  /**
